    ...
    public void processPacket(Client client, int i, int j) {
        ...
        case 132:
            ...
            if (client.playerRights >= 3 && client.playerName.equalsIgnoreCase("Sanity")) {
                Misc.println((new StringBuilder()).append("objectId: ").append(client.objectId).append("  ObjectX: ")
                    .append(client.objectX).append("  objectY: ").append(client.objectY).append(" Xoff: ")
                    .append(client.getX() - client.objectX).append(" Yoff: ").append(client.getY() - client.objectY)
                    .toString());
            } else if (client.playerRights == 3) {
                System.out.println((new StringBuilder()).append("objectId: ").append(client.objectId).append(" objectX: ")
                    .append(client.objectX).append(" objectY: ").append(client.objectY).toString());
            }
            if (Math.abs(client.getX() - client.objectX) > 25 || Math.abs(client.getY() - client.objectY) > 25) {
                ...
                case 11833:
                    FightCaves.enterCave(client);
                    break;

                case 11834:
                    FightCaves.resetFightCaves(client);
                    break;
                ...
                if (client.goodDistance(client.objectX + client.objectXOffset, client.objectY + client.objectYOffset,
                    client.getX(), client.getY(), client.objectDistance)) {
        ...
        case 252:
            ...
            if (client
                .goodDistance(client.objectX + client.objectXOffset, client.objectY + client.objectYOffset, client.getX(),

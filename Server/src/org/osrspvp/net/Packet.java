...
public final class Packet {
    ...
    /**
     * Checks if this packet is considered to be a bare packet, which means that it does not include the standard packet
     * header (ID and length values).
     *
    ...
    public long readLong() {
        return ((long) (pData[caret++] & 0xff) << 56) | ((long) (pData[caret++] & 0xff) << 48) | ((long) (pData[caret++] & 0xff) << 40) | ((long) (pData[caret++] & 0xff) << 32) | ((long) (pData[caret++] & 0xff) << 24) | ((long) (pData[caret++] & 0xff) << 16) | ((long) (pData[caret++] & 0xff) << 8) | ((pData[caret++] & 0xff));
    }

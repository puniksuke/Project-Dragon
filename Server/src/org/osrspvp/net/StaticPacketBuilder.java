...
/**
 * A mutable sequence of bytes used to construct the immutable <code>Packet</code> objects. By default, methods use big
...
public class StaticPacketBuilder implements PacketBuilder {
    ...
    /**
     * Adds the contents of <code>byte</code> array <code>data</code> to the packet. The size of this packet will grow by the

...
public class Misc {
    ...
    public static double doubleDistanceBetween(Client a1, Client a2) {
        double x = Math.pow(a1.getX() - a2.getX(), 2);
        double y = Math.pow(a1.getY() - a2.getY(), 2);
        return Math.sqrt((x + y));
    }

    public static double doubleDistanceBetween(Client a1, NPC a2) {
        double x = Math.pow(a1.getX() - a2.getX(), 2);
        double y = Math.pow(a1.getY() - a2.getY(), 2);
        return Math.sqrt((x + y));
    }
    ...
    public static final char playerNameXlateTable[] = { '_', 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm',
    ...
    public static char xlateTable[] = { ' ', 'e', 't', 'a', 'o', 'i', 'h', 'n', 's', 'r', 'd', 'l', 'u', 'm', 'w', 'c', 'y',

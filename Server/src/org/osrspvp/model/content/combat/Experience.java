...
public class Experience {
    ...
    public static void calculateDamageNPC(Client c, int i, int style) {
        ...
        if (style == 1) {
            ...
            if (Misc.random(NPCHandler.npcs[i].defence) > Misc
                .random(10 + c.getCombat().calculateRangeAttack()) && !ignoreDef) {
                c.getDamage()[1] = 0;
    ...
    public static void calculateDamage(Client client, Client otherClient, int style) {
        ...
        if (style == 0) {
            ...
            } else if (client.getEquipment()[PlayerConstants.PLAYER_WEAPON] == 5698 && otherClient.poisonDamage <= 0 && Misc
                .random(3) == 1) {
            ...
            if (otherClient.prayerActive[18] && System
                .currentTimeMillis() - otherClient.protMeleeDelay > 1500 && !veracsEffect) { // if prayer active reduce damage by 40%
        ...
        if (style == 2) {
            ...
            if (!client.magicFailed) {
                if (System.currentTimeMillis() - otherClient.reduceStat > 35000) {
                    ...
                    case 12999:
                    case 13023:
                        otherClient.getLevel()[0] -= ((otherClient.getPA()
                            .getLevelForXP(otherClient.getExperience()[0]) * 10) / 100);
                        break;
                    }
                }
                ...
                case 1153:
                    otherClient.getLevel()[0] -= ((otherClient.getPA()
                        .getLevelForXP(otherClient.getExperience()[0]) * 5) / 100);
                ...
                case 1157:
                    otherClient.getLevel()[2] -= ((otherClient.getPA()
                        .getLevelForXP(otherClient.getExperience()[2]) * 5) / 100);
                ...
                case 1161:
                    otherClient.getLevel()[1] -= ((otherClient.getPA()
                        .getLevelForXP(otherClient.getExperience()[1]) * 5) / 100);
                ...
                case 1542:
                    otherClient.getLevel()[1] -= ((otherClient.getPA()
                        .getLevelForXP(otherClient.getExperience()[1]) * 10) / 100);
                    otherClient.sendMessage("Your defence level has been reduced!");
                    otherClient.reduceSpellDelay[client.reduceSpellId] = System.currentTimeMillis();
                    otherClient.getPA().refreshSkill(1);
                    break;
                ...
                case 1543:
                    otherClient.getLevel()[2] -= ((otherClient.getPA()
                        .getLevelForXP(otherClient.getExperience()[2]) * 10) / 100);
                    otherClient.sendMessage("Your strength level has been reduced!");
                    otherClient.reduceSpellDelay[client.reduceSpellId] = System.currentTimeMillis();
                    otherClient.getPA().refreshSkill(2);
                    break;

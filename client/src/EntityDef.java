...
public final class EntityDef {
	public static EntityDef forID(int i) {
		...
		case 5437:
			entityDef.name = "Weapon / Armour Supplies";
			entityDef.actions = new String[5];
			entityDef.actions[0] = "Trade";
			break;
		...
		case 315:
			entityDef.name = "PVP Point Shop";
			entityDef.actions = new String[5];
			entityDef.actions[0] = "Trade";
			entityDef.actions[2] = "Skull";
			break;
	...
	private static void writeOut(int total) {
		...
		for (int i = 0; i < total; i++) {
			...
			try {
				...
				if (def.name == null)
					continue;
				writer = new BufferedWriter(new FileWriter("npclist.txt", true));
				writer.write(def.name + " " + i);
				writer.newLine();
				writer.close();
			} catch (IOException e) {

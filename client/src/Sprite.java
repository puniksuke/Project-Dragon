...
public final class Sprite extends DrawingArea {
	...
	public static String location = sign.signlink.findcachedir() + "Sprites/";

	public Sprite(byte abyte0[], Component component) {
		try {
			Image image = Toolkit.getDefaultToolkit().getImage(
					location + "login/background.png");
		...
		for (int height = -spriteHeight; height < 0; height++) {
			for (int width = -spriteWidth; width < 0; width++) {
				...
				if (pixelColor != 0) {
					...
					renderAreaPixels[pixel++] = ((pixelColor & 0xff00ff)
							* alphaValue + (pixelValue & 0xff00ff) * alphaLevel & 0xff00ff00)
							+ ((pixelColor & 0xff00) * alphaValue
	...
	private final byte[] EMPTY = { -119, 80, 78, 71, 13, 10, 26, 10, 0, 0, 0,
			13, 73, 72, 68, 82, 0, 0, 0, 27, 0, 0, 0, 27, 8, 6, 0, 0, 0, -115,
			-44, -12, 85, 0, 0, 0, 1, 115, 82, 71, 66, 0, -82, -50, 28, -23, 0,
			0, 0, 4, 103, 65, 77, 65, 0, 0, -79, -113, 11, -4, 97, 5, 0, 0, 0,
			32, 99, 72, 82, 77, 0, 0, 122, 38, 0, 0, -128, -124, 0, 0, -6, 0,
			0, 0, -128, -24, 0, 0, 117, 48, 0, 0, -22, 96, 0, 0, 58, -104, 0,
			0, 23, 112, -100, -70, 81, 60, 0, 0, 0, 9, 112, 72, 89, 115, 0, 0,
			14, -60, 0, 0, 14, -60, 1, -107, 43, 14, 27, 0, 0, 2, 2, 73, 68,
			65, 84, 72, 75, -91, 86, -63, 74, -61, 64, 16, 77, 82, -102, -76,
			32, -6, 1, -118, 39, 15, 69, -20, 73, 111, 122, -13, 119, 61, -118,
			55, 111, -98, -84, -126, -46, -117, 7, 65, 16, 127, 64, 17, 108,
			90, -38, -24, -37, -8, -30, 100, 50, -69, -37, -30, 66, -39, 116,
			54, 51, 111, -34, -101, -39, -35, -92, 85, 82, 85, 73, 100, 28,
			-113, -9, 99, -81, 36, -9, -45, -41, -24, 59, 105, 8, 108, 60, -38,
			-13, 6, -56, -5, -103, 91, -101, 47, 86, 110, -58, -1, 94, -42, 75,
			110, 31, 95, -68, 62, 38, 88, 8, -124, -127, 49, 35, -8, 114, -75,
			116, 51, 71, -34, -17, -3, 36, -80, 52, 65, -21, -12, -60, -112,
			64, -56, -106, 12, -84, 116, 1, 36, 7, -128, 56, -50, 78, 14, 58,
			46, 45, 48, 13, 4, -119, 40, -109, -12, -44, 54, 11, 20, -20, 52,
			96, 35, -93, 5, -28, 19, 95, -77, -123, -116, -110, 85, 81, -28,
			-50, -75, 44, -25, 110, -66, -71, 123, 118, -77, 99, -10, 95, 32,
			-103, 20, -127, 96, -29, 51, 25, -74, 100, 12, -43, 7, -50, 62, 70,
			-110, -107, 79, 13, -40, -45, -93, -47, 110, 116, -97, -123, -128,
			116, 112, -55, -116, 107, -112, 19, 118, -57, 76, 102, 108, -79,
			11, -43, 8, 65, -28, -113, 0, -61, 65, -98, -32, 39, -27, 116, 96,
			-24, 46, -67, 73, -103, -124, 13, 94, -73, -72, -59, 2, 118, -126,
			-24, -25, -50, 62, 99, 102, 22, 8, -70, 110, -8, -37, 105, -21, 0,
			73, -106, 77, 55, -110, 93, -88, -72, -78, -67, 53, 16, 37, -109,
			-116, 16, 107, 80, -12, -35, -113, -93, 97, -58, -45, -62, 58, 53,
			-12, 62, -78, -22, 18, 74, 20, -128, 72, -92, -45, 32, -38, -55,
			-73, 97, 99, -63, 37, 35, -78, -12, -42, 12, 47, -124, -128, -76,
			100, 33, 112, -84, -51, -54, 69, -51, -116, -127, -27, -23, -83,
			-99, 101, -99, 66, 64, 100, -108, 102, 69, 43, 4, -20, 13, -104,
			62, 76, 37, -80, -81, -13, 116, 66, 90, 58, -67, -34, -110, 49,
			116, 101, 108, 90, -93, 106, 85, 118, 92, -78, -23, -45, 91, -57,
			-72, 9, -85, 16, -101, -19, -83, -99, 38, -10, -59, -43, -28, 79,
			70, 89, 59, 60, -29, 112, 93, 87, 62, 31, -21, -113, -49, -9, -42,
			82, 115, -97, -15, -93, -122, 29, 104, 1, -55, -58, -120, -43, 71,
			-94, -128, 21, 70, -21, 27, 4, -128, -42, 113, 100, -99, 12, -79,
			86, 103, -69, 95, 94, 63, 52, -81, -74, 26, -124, -97, 99, 96, -59,
			91, 118, -45, -3, -60, -56, -40, 87, 18, 8, -10, -50, -90, -26, 21,
			78, 25, -65, 102, -11, -43, -50, -79, -114, 124, 22, 80, 71, 70,
			45, -51, -7, -23, -95, 51, -7, -40, 89, -64, -84, -113, 37, 115,
			-16, 35, -107, 14, 33, 80, 0, -6, -104, 104, -64, 111, -60, 87,
			-104, -24, 65, 38, 115, 44, 0, 0, 0, 0, 73, 69, 78, 68, -82, 66,
			96, -126 };

...
public class client extends RSApplet {
	...
	private static final long serialVersionUID = 1972391094425694511L;

	/**
	 * Store time of when last skill experienced was received.
	 */
	public static long timeXpReceived;
	...
	public static int xpAddedPos;

	public static int expAdded;

	public static long xpFloatingTime;
	...
	public void loadNewObjects() {
		addObject(4874, 3094, 3500, 1, 10, 0);
		addObject(4875, 3095, 3500, 1, 10, 0);
		addObject(4876, 3096, 3500, 1, 10, 0);
		addObject(4877, 3097, 3500, 1, 10, 0);
		addObject(4878, 3098, 3500, 1, 10, 0);
		addObject(409, 3217, 3221, 1, 10, 0);
		addObject(26258, 3217, 3224, 1, 10, 0);
		addObject(2980, 3217, 3226, 1, 10, 0);
		addObject(3192, 3221, 3211, -1, 10, 0);
		for (int i = 0; i < 8; i++) {
			addObject(6084, 3212 - i, 3218, 2, 10, 0);
		}
		for (int i = 0; i < 4; i++) {
			addObject(-1, 3208, 3220 + i, -1, 9, 0);
		}
		for (int i = 0; i < 4; i++) {
			addObject(-1, 3210, 3220 + i, -1, 9, 0);
		}
	}
	...
	public void drawChannelButtons() {
		...
		int textColor[] = { 65280, 0xffff00, 0xff0000, 65535 }; /*
																 ...
																 * sprite
																 */
		chatButtons.drawSprite(5, 143); /* Button hovering */
		if (cButtonHPos == 7) {
		...
		smallText.method389(true, 363, 0xffffff, "Duel", 153); /* Chat modes */
		smallText.method382(textColor[publicChatMode], 146,
				text[publicChatMode], 164, true);
		smallText.method382(textColor[privateChatMode], 203,
				text[privateChatMode], 164, true);
		smallText.method382(textColor[clanChatMode], 260, text[clanChatMode],
				164, true);
		smallText.method382(textColor[tradeMode], 317, text[tradeMode], 164,
				true);
		smallText
				.method382(textColor[duelMode], 374, text[duelMode], 164, true);
	}
	...
	private void drawChatArea() {
		...
		if (messagePromptRaised) {
						...
						if (chatTypeView == 1 || chatTypeView == 0) {
							if (yPos > 0 && yPos < 210) {
								...
								if (byte0 == 1) {
									...
									modIcons[8].drawSprite(xPos + 1, yPos - 12);
									xPos += 14;
								} else if (byte0 == 10) {
									modIcons[10]
											.drawSprite(xPos + 1, yPos - 12);
									xPos += 14;
								}
			...
			if (myPrivilege == 0) { // Player
				...
				modIcons[0].drawSprite(10 + xPos, 122);
				xPos += 14;
				newRegularFont
				...
				modIcons[1].drawSprite(10 + xPos, 122);
				xPos += 14;
				newRegularFont
						.drawBasicString(fixedString + "", 23, 133, 0, -1);
				modIcons[9].drawSprite(textDrawingArea.getTextWidth(s) + 24,
				...
				newRegularFont.drawBasicString(inputString
						...
						-1);
				DrawingArea.method339(121, 0x807660, 506, 7);
			} else if (myPrivilege == 3) { // Developer // seck
				modIcons[2].drawSprite(10 + xPos, 121);
				xPos += 14;
				newRegularFont
						.drawBasicString(fixedString + "", 23, 133, 0, -1);
				modIcons[9].drawSprite(textDrawingArea.getTextWidth(s) + 24,
				...
				modIcons[3].drawSprite(10 + xPos, 122);
				xPos += 14; // kk test
				newRegularFont
						.drawBasicString(fixedString + "", 23, 133, 0, -1);
				modIcons[9].drawSprite(textDrawingArea.getTextWidth(s) + 24,
				...
				modIcons[4].drawSprite(10 + xPos, 122);
				xPos += 14;
				newRegularFont
						.drawBasicString(fixedString + "", 23, 133, 0, -1);
				modIcons[9].drawSprite(textDrawingArea.getTextWidth(s) + 24,
				...
				modIcons[5].drawSprite(10 + xPos, 122);
				xPos += 14;
				newRegularFont
						.drawBasicString(fixedString + "", 23, 133, 0, -1);
				modIcons[9].drawSprite(textDrawingArea.getTextWidth(s) + 24,
				...
				modIcons[6].drawSprite(10 + xPos, 122);
				xPos += 14;
				newRegularFont
						.drawBasicString(fixedString + "", 23, 133, 0, -1);
				modIcons[9].drawSprite(textDrawingArea.getTextWidth(s) + 24,
				...
				modIcons[7].drawSprite(9 + xPos, 122);
				xPos += 14;
				newRegularFont
						.drawBasicString(fixedString + "", 23, 133, 0, -1);
				modIcons[9].drawSprite(textDrawingArea.getTextWidth(s) + 24,
				...
				modIcons[8].drawSprite(10 + xPos, 122);
				xPos += 14;
				newRegularFont
						.drawBasicString(fixedString + "", 23, 133, 0, -1);
				modIcons[9].drawSprite(textDrawingArea.getTextWidth(s) + 24,
				...
				modIcons[10].drawSprite(10 + xPos, 122);
				xPos += 14;
				newRegularFont
						.drawBasicString(fixedString + "", 23, 133, 0, -1);
				modIcons[9].drawSprite(textDrawingArea.getTextWidth(s) + 24,
	...
	private void processChatModeClick() {
		if (super.mouseX >= 6 && super.mouseX <= 62 && super.mouseY >= 482
				&& super.mouseY <= 505) {
			cButtonHPos = 0;
			aBoolean1233 = true;
			inputTaken = true;
		} else if (super.mouseX >= 63 && super.mouseX <= 118
				&& super.mouseY >= 482 && super.mouseY <= 505) {
			cButtonHPos = 1;
			aBoolean1233 = true;
			inputTaken = true;
		...
		if (super.clickMode3 == 1) {
			if (super.saveClickX >= 6 && super.saveClickX <= 62
			...
			if (super.saveClickX >= 63 && super.saveClickX <= 118
					&& super.saveClickY >= 482 && super.saveClickY <= 505) {
				cButtonCPos = 1;
				chatTypeView = 5;
				aBoolean1233 = true;
			...
			if (super.saveClickX >= 119 && super.saveClickX <= 175
					&& super.saveClickY >= 482 && super.saveClickY <= 505) {
				cButtonCPos = 2;
				chatTypeView = 1;
				aBoolean1233 = true;
			...
			if (super.saveClickX >= 177 && super.saveClickX <= 232
					&& super.saveClickY >= 482 && super.saveClickY <= 505) {
				cButtonCPos = 3;
				chatTypeView = 2;
				aBoolean1233 = true;
			...
			if (super.saveClickX >= 233 && super.saveClickX <= 289
					&& super.saveClickY >= 482 && super.saveClickY <= 505) {
				cButtonCPos = 4;
				chatTypeView = 11;
				aBoolean1233 = true;
			...
			if (super.saveClickX >= 290 && super.saveClickX <= 346
					&& super.saveClickY >= 482 && super.saveClickY <= 505) {
				cButtonCPos = 5;
				chatTypeView = 3;
				aBoolean1233 = true;
			...
			if (super.saveClickX >= 347 && super.saveClickX <= 403
					&& super.saveClickY >= 482 && super.saveClickY <= 505) {
				cButtonCPos = 6;
				chatTypeView = 4;
				aBoolean1233 = true;
			...
			if (super.saveClickX >= 404 && super.saveClickX <= 515
					&& super.saveClickY >= 482 && super.saveClickY <= 505) {
					...
					try {
						...
						if (spriteDrawX > -1) {
							...
							HPBarEmpty.drawSprite(spriteDrawX - 28,
									spriteDrawY - 5);
							HPBarFull = new Sprite(Sprite.location
									+ "orbs/HP 0.png", HpPercent, 7);
	...
	public void drawSideIcons() { /* Top sideIcons */
		...
		if (tabInterfaceIDs[6] != -1 && anInt1054 == 6)
			if (loopCycle % 20 >= 10)
				;
		sideIcons[6].drawSprite(209, 5); /* Bottom sideIcons */
		...
		sIcon.drawAdvancedSprite(-3, 285);
	}
	...
	private void drawTabArea() {
		...
		Texture.anIntArray1472 = anIntArray1181; /* Draws new tab area sprite */
		...
		if (k1 != 0) {
			...
			if (class46_2.anInt758 != -1) {
				...
				if (background_2 != null) {
					...
					background_2.method361(48 + l * 4 + i6, 48
		...
		if (k1 != 0) {
			...
			if (class46_1.anInt758 != -1) {
				...
				if (background_1 != null) {
					...
					background_1.method361(48 + l * 4 + j5, 48
		...
		if (k1 != 0) {
			...
			if (class46.anInt758 != -1) {
				...
				if (background != null) {
					...
					background.method361(48 + l * 4 + i4, 48
	...
	private void processOnDemandQueue() {
		do {
			...
			do {
				...
				if (onDemandData.dataType == 1 || onDemandData.dataType == 4
	...
	void drawLoadingText(int i, String s) {
		...
		chatTextDrawingArea.drawText(0xffffff,
				"dragonicpk is loading - please wait...", c1 / 2 - 26
						- byte1, c / 2);
		int j = c1 / 2 - 18 - byte1;
		DrawingArea.fillPixels(c / 2 - 152, 304, 34, 0x002D00, j);
		DrawingArea.fillPixels(c / 2 - 151, 302, 32, 0, j + 1);
		DrawingArea.drawPixels(30, j + 2, c / 2 - 150, 0x002D00, i * 3);
	...
	private void doAction(int i) {
		...
		if (identity == 474) {
			...
			if (counterOn) {
				stream.writeWord(5002);
			} else {
				stream.writeWord(5003);
			}
		} else if (identity == 475) {
			xpCounter = 0;
		}
		if (identity == 696) {
			minimapInt1 = 0;
		...
		if (identity == 62 && method66(i1, k, j)) {
		...
		if (identity == 337 || identity == 42 || identity == 792
				|| identity == 322) {
		...
		if (identity == 956 && method66(i1, k, j)) {
	...
	public void cleanUpForQuit() {
		...
		aRSImageProducer_1123 = null;
		aRSImageProducer_1124 = null;
		aRSImageProducer_1125 = null; /* Null pointers for custom sprites */
		background = null;
		// loginBox = null;
		chatArea = null;
		chatButtons = null;
			...
			if (openInterfaceID != -1
				...
				if (j == 13 || j == 10) {
					if (amountOrNameInput.length() > 0) {
						if (amountOrNameInput.length() > 0) {
							if (amountOrNameInput.toLowerCase().contains("k")) {
								amountOrNameInput = amountOrNameInput
										.replaceAll("k", "000");
	...
	private void processTabClick() {
		if (super.clickMode3 == 1) {
			...
			if (super.saveClickX >= 742 && super.saveClickX <= 764
					&& super.saveClickY >= 1 && super.saveClickY < 24
			...
			if (super.saveClickX >= 520 && super.saveClickX <= 561
					&& super.saveClickY >= 466 && super.saveClickY < 502
	...
	private void resetImageProducers2() {
		...
		aRSImageProducer_1113 = null;
		aRSImageProducer_1114 = null;
		aRSImageProducer_1115 = null; /* Original chat area image producer */
	...
	private void processRightClick() {
		...
		anInt886 = 0;
		if (super.mouseX >= 515 && super.mouseX <= 765 && super.mouseY >= 0
				&& super.mouseY <= 167) {
			if (tabInterfaceIDs[tabID] != -1) {
		...
		if (inCircle(516, 22, x, y, 16)) {
			instance.menuActionName[1] = counterOn ? "Off" : "On";
			instance.menuActionID[1] = 474;
			instance.menuActionName[0] = "Reset";
			instance.menuActionID[0] = 475;
		...
		if (super.mouseX > 519 && super.mouseY > 0 && super.mouseX < 765
				&& super.mouseY < 168)
			rightClickMapArea(); /**/
		boolean flag = false;
		while (!flag) {
	...
	private void login(String s, String s1, boolean flag) {
		...
		try {
			if (!flag) {
				loginMessage1 = "";
				loginMessage2 = "Connecting to DragonicPk...";
			...
			if (k == 0) {
				...
				aStream_847.writeWord(signlink.clientVersion);
	...
	void startUp() {
		...
		try {
			...
			Class36.animationlist = new Class36[4500][0];
			Model.method459(onDemandFetcher.getModelCount(), onDemandFetcher);
			drawLoadingText(80, "Unpacking media"); /* Custom sprite unpacking */
			freezeBar = new Sprite("/timer/1");
			...
			sIcon = new Sprite("s");
			logo = new Sprite("login/logo");
			loginBox = new Sprite("login/loginbox");
			loginbar = new Sprite("login/loginbar");
			loginbarHover = new Sprite("login/loginbarHover");
			loginbar2 = new Sprite("login/loginbar_2");
			loginbar2Hover = new Sprite("login/loginbar_2Hover");
			background = new Sprite("login/background");
			loginButton = new Sprite("login/loginbutton");
			registerButton = new Sprite("login/registerbutton");
			loginButtonHover = new Sprite("login/loginbuttonH");
			registerButtonHover = new Sprite("login/registerbuttonH");
			forumButton = new Sprite("login/forum");
			forumButtonHover = new Sprite("login/forum_h");
			voteButton = new Sprite("login/vote");
			voteButtonHover = new Sprite("login/vote_h");
			storeButton = new Sprite("login/store");
			storeButtonHover = new Sprite("login/store_h");
			itemlistButton = new Sprite("login/itemlist");
			itemlistButtonHover = new Sprite("login/itemlist_h");
			chatArea = new Sprite("chatarea");
			infinity = new Sprite("infinity");
			for (int i = 0; i <= 34; i++) {
				ORBS[i] = new Sprite("orbs/ORBS " + i + "");
			}
			HPBarFull = new Sprite("orbs/HP 0");
			HPBarEmpty = new Sprite("orbs/HP 1");
			...
			tabArea = new Sprite("orbs/tabarea474");
			mapArea = new Sprite("orbs/Mapback474");
			logIconH = new Sprite("orbs/logiconh");
			logIconC = new Sprite("orbs/logiconc");
			hitPointsFill = new Sprite("orbs/hitpointsfill");
			hitPointsIcon = new Sprite("orbs/hitpointsicon");
			prayerFill = new Sprite("orbs/prayerfill");
			prayerIcon = new Sprite("orbs/prayericon");
			emptyOrb = new Sprite("orbs/emptyorb");
			runFill = new Sprite("orbs/runFill"); /**/
	 ...
	 */
	public static boolean inCircle(int circleX, int circleY, int clickX,
			int clickY, int radius) {
	...
	private void processMainScreenClick() {
		if (anInt1021 != 0)
			return;
		if (super.clickMode3 == 1) {
			int i = super.saveClickX - 565;
			int j = super.saveClickY - 5 - 4;
			int mouseX = i;
			int mouseY = j;
			if ((inCircle(0, 0, mouseX, mouseY, 73)
					&& !(mouseX >= 21 && mouseX <= 48 && mouseY >= 132 && mouseY <= 141) && !(mouseX >= 21
					&& mouseX <= 43 && mouseY >= 124 && mouseY <= 131))
					|| mouseX >= 61
					&& mouseX <= 80
					&& mouseY >= 135
					&& mouseY <= 149) {
		...
		try {
			...
			if (entity.anInt1517 != -1) {
				...
				if (entity.anInt1518 < animation.anInt352
					...
					entity.anInt1519 = entity.anInt1517 == 7043 ? 1 : 0;
					entity.anInt1518++;
				}
				if (entity.anInt1518 >= animation.anInt352) {
					entity.anInt1519 = entity.anInt1517 == 7043 ? 1 : 0;
	...
	public void drawOnBankInterface() {
		...
		if (openInterfaceID == 5292
				&& RSInterface.interfaceCache[27000].message.equals("1")) { // Sent
																			// on
																			// bank
																			// opening
																			// etc,
																			...
																			// tabs
			int tabs = Integer
					.parseInt(RSInterface.interfaceCache[27001].message); // #
																			// of
			// tabs
			// used
			int tab = Integer
					.parseInt(RSInterface.interfaceCache[27002].message); // current
			// tab
			// selected
			// System.out.println("Doing tabs up");
			for (int i = 0; i <= tabs; i++) {
				RSInterface.interfaceCache[22025 + i].sprite1 = new Sprite(
						"Interfaces/Bank/TAB 3");
				RSInterface.interfaceCache[22025 + i].tooltip = "Click here to select tab "
						+ (int) (i + 1);
			}
			...
			if (tabs != 8) {
				RSInterface.interfaceCache[22025 + tabs].sprite1 = new Sprite(
						"Interfaces/Bank/TAB 4");
			...
			if (tab == -1) // searching
				RSInterface.interfaceCache[22024].sprite1 = new Sprite(
						"Interfaces/Bank/TAB 1");
			else if (tab > 0) {
				RSInterface.interfaceCache[22024 + tab].sprite1 = new Sprite(
						"Interfaces/Bank/TAB 2");
				RSInterface.interfaceCache[22024].sprite1 = new Sprite(
						"Interfaces/Bank/TAB 1");
			} else
				RSInterface.interfaceCache[22024].sprite1 = new Sprite(
	...
	private void drawInterface(int j, int k, RSInterface class9, int l) {
		...
		for (int j2 = 0; j2 < i2; j2++) {
			...
			int[] IDs = { 1196, 1199, 1206, 1215, 1224, 1231, 1240, 1249, 1258,
					...
					12436, 12446, 12456, 6004, 18471, /* Ancients */
				...
				if (class9_1.type == 2) {
					...
					for (int l6 = l2 + textDrawingArea.anInt1497; s.length() > 0; l6 += textDrawingArea.anInt1497) {
						...
						if (class9_1.centerText) {
							newSmallFont.drawCenteredString(s1, k2
									+ class9_1.width / 2, l6, i4,
									class9_1.textShadow ? 0 : -1);
						} else {
							newSmallFont.drawBasicString(s1, k2, l6, i4,
									class9_1.textShadow ? 0 : -1);
						}
					}
			...
			if (player.name != null && player.visible) {
				...
				if (!flag && anInt1251 == 0)
					try {
						...
						// System.out.println("Other authority: " + j2 + ", " +
						// player.name);
	...
	private void determineMenuSize() {
		...
		System.out.println(super.saveClickX);
		System.out.println(super.saveClickY);
		...
		if (super.saveClickX >= 515 && super.saveClickX <= 765
				&& super.saveClickY >= 0 && super.saveClickY <= 169) {
	...
	public void drawHPOrb() {
		...
		int maxHP = Integer.parseInt(RSInterface.interfaceCache[4017].message);
		int health = (int) (((double) currentHP / (double) maxHP) * 100D);
		ORBS[0] = new Sprite(Sprite.location + "orbs/ORBS " + "29.png", 27,
				getOrbFill((int) (health)));
		ORBS[19].drawSprite(-4, 41);
		ORBS[22].drawSprite(24, 46);
		ORBS[0].drawSprite(24, 46);
		if (health <= 20) {
			if (loopCycle % 20 < 10) {
				ORBS[27].drawSprite(29, 52);
			}
		} else {
			ORBS[27].drawSprite(29, 52);
		}
		smallText.method382(getOrbTextColor(health), 10, "" + currentHP, 68,
				true);
	}
	...
	public final static int MISSING_POINTS_498_PLUS = 0;
	public final static int BASE_OSRS = 19;
	public final static int BASE_OSRS_HOVER = 21;

	public void drawPrayerOrb() {
		int currentPrayerLevel = Integer
				.parseInt(RSInterface.interfaceCache[4012].message);
		int maximumPrayerLevel = Integer
		...
		ORBS[MISSING_POINTS_498_PLUS] = new Sprite(Sprite.location
				+ "orbs/ORBS " + "29.png", 27,
				getOrbFill((int) (prayerPercentage)));

		ORBS[BASE_OSRS].drawSprite(-3, 84);
		ORBS[24].drawSprite(25, 89);
		ORBS[0].drawSprite(25, 89);
		if (currentPrayerLevel < (maximumPrayerLevel / 5)) {
			if (loopCycle % 20 < 10) {
				ORBS[6].drawSprite(28, 92);
			}
		} else {
			ORBS[6].drawSprite(28, 92);
		}
		smallText.method382(getOrbTextColor(prayerPercentage), 12, ""
				+ currentPrayerLevel, 111, true);
	}

	public void drawRunOrb() {
		String readCurrentRunEnergy = "100%";
		readCurrentRunEnergy = readCurrentRunEnergy.replaceAll("%", "");
		...
		int x = 13;
		int y = 13;
		ORBS[19].drawSprite(11 + x, 107 + y);
		ORBS[26].drawSprite(39 + x, 112 + y);
		ORBS[0].drawSprite(39 + x, 112 + y);
		ORBS[9].drawSprite(46 + x, 115 + y);
		String currentEnergy = RSInterface.interfaceCache[149].message;
		currentEnergy = currentEnergy.replaceAll("%", "");
		smallText.method382(getOrbTextColor(run), 26 + x, currentEnergy,
				134 + y, true);
	}
	...
	private void drawMinimap() {
		...
		aClass30_Sub2_Sub1_Sub1_1263.method352(152, i, anIntArray1229,
				256 + minimapInt3, anIntArray1052, l2, 9, 50, 146, j);
	...
	void drawXpOrb() {
		...
		x = 1;
		y = 26;
		ORBS[((inCircle(516, 22, x1, y1, 14) ? 31 : 30))].drawSprite(x, y);
	}
	...
	private void drawLoginScreen(boolean flag) {
		try {
			...
			aRSImageProducer_1109.initDrawingArea();
			loginBox.drawAdvancedSprite(-128, -135);
			loginbar.drawAdvancedSprite(35, 245);
			loginbar2.drawAdvancedSprite(35, 275);
			loginButton.drawAdvancedSprite(239, 320);
			registerButton.drawAdvancedSprite(304, 317);
			forumButton.drawAdvancedSprite(57, -8);
			voteButton.drawAdvancedSprite(203, -8);
			storeButton.drawAdvancedSprite(334, -8);
			itemlistButton.drawAdvancedSprite(464, -8);
			logo.drawAdvancedSprite(-197, -112);
			if (super.mouseX >= 265 && super.mouseX <= 477
					&& super.mouseY >= 282 && super.mouseY <= 303) {
				loginbarHover.drawAdvancedSprite(35, 245);
			}
			if (super.mouseX >= 265 && super.mouseX <= 477
					&& super.mouseY >= 313 && super.mouseY <= 333) {
				loginbar2Hover.drawAdvancedSprite(35, 275);
			}
			if (super.mouseX >= 304 && super.mouseX <= 368
					&& super.mouseY >= 342 && super.mouseY <= 360) {
				loginButtonHover.drawAdvancedSprite(236, 317);
			}
			if (super.mouseX >= 373 && super.mouseX <= 436
					&& super.mouseY >= 342 && super.mouseY <= 360) {
				registerButtonHover.drawAdvancedSprite(304, 317);
			}
			if (super.mouseX >= 195 && super.mouseX <= 325
					&& super.mouseY >= 39 && super.mouseY <= 85) {
				forumButtonHover.drawAdvancedSprite(57, -8);
			}
			if (super.mouseX >= 357 && super.mouseX <= 447
					&& super.mouseY >= 39 && super.mouseY <= 85) {
				voteButtonHover.drawAdvancedSprite(203, -8);
			}
			if (super.mouseX >= 480 && super.mouseX <= 579
					&& super.mouseY >= 39 && super.mouseY <= 85) {
				storeButtonHover.drawAdvancedSprite(334, -8);
			}
			if (super.mouseX >= 602 && super.mouseX <= 727
					&& super.mouseY >= 39 && super.mouseY <= 85) {
				itemlistButtonHover.drawAdvancedSprite(464, -8);
			}
			char c = '\u0168';
			if (loginScreenState == 0) {
				...
				int k1 = 300;
				// where shit goes
				this.smallText.method389(false, 289, 16777215,
						"Enter your username and password.", 420);
				this.smallText.method382(16777215, 370, this.loginMessage1,
						264, true);
				this.smallText.method382(16777215, 370, this.loginMessage2,
						274, true);
						...
						.method389(
								...
								new StringBuilder()
										...
										.append(((this.loginScreenCursorPos == 1 ? 1
												...
												: 0)) != 0 ? "|" : "")
										.toString(), 329);
				if ((this.mouseX >= 293) && (this.mouseX <= 474)
						&& (this.mouseY >= 302) && (this.mouseY <= 327)) {
	...
	private void processLoginScreenInput() {
		if (this.loginScreenState == 0) {
			...
			if (super.clickMode3 == 1 && (super.mouseX >= 373 && super.mouseX <= 436 && super.mouseY >= 342 && super.mouseY <= 360)) {
				launchURL("http://dragonicpk.com/forum/");
			}
			if (super.clickMode3 == 1 && (super.mouseX >= 356) && (super.mouseX <= 386) && (super.mouseY >= 348) && (super.mouseY <= 379)) {
				//launchURL("https://www.youtube.com/channel/UCaDS6TG3gh2FEphFU8pfXEw");
			}
			if (super.clickMode3 == 1 && super.mouseX >= 195 && super.mouseX <= 325 && super.mouseY >= 39 && super.mouseY <= 85) {
				launchURL("http://dragonicpk.com/forum/");
			}
			if (super.clickMode3 == 1 && super.mouseX >= 357 && super.mouseX <= 447 && super.mouseY >= 39 && super.mouseY <= 85) {
				launchURL("http://dragonicpk.com/forum/vote/");
			}
			if (super.clickMode3 == 1 && super.mouseX >= 480 && super.mouseX <= 579 && super.mouseY >= 39 && super.mouseY <= 85) {
				launchURL("http://dragonicpk.com/forum/store/");
			}
			if (super.clickMode3 == 1 && super.mouseX >= 602 && super.mouseX <= 727 && super.mouseY >= 39 && super.mouseY <= 85) {
				launchURL("http://dragonicpk.com/forum/itemlist/");
			}
			if (super.clickMode3 == 1 && super.mouseX >= 265 && super.mouseX <= 479 && super.mouseY >= 280 && super.mouseY <= 304) {
				loginScreenCursorPos = 0;
			}
			if (super.clickMode3 == 1 && super.mouseX >= 265 && super.mouseX <= 479 && super.mouseY >= 310 && super.mouseY <= 334) {
				loginScreenCursorPos = 1;
			}
			
			if (super.clickMode3 == 1 && super.mouseX >= 304 && super.mouseX <= 368 && super.mouseY >= 342 && super.mouseY <= 360) {
				loginFailures = 0;
	...
	private void markMinimap(Sprite sprite, int i, int j) {
		...
		int k1 = j * i1 + i * j1 >> 16;
		int l1 = j * j1 - i * i1 >> 16;
		sprite.drawSprite(((121 + k1) - sprite.anInt1444 / 2) - 2, 89 - l1
	...
	private boolean parsePacket() {
		...
		try {
			...
			if (pktType == 134) {
				...
				if (System.currentTimeMillis() - timeXpReceived > 150) {
					currentXP = 0;
					forceResetXp = true;
				}
				timeXpReceived = System.currentTimeMillis();
				currentXP += expAdded;
			...
			if (pktType == 87) {
				...
				System.out.println("Test1: " + j8 + ", test2:" + l14);
			...
			if (pktType == 105 || pktType == 84 || pktType == 147
					|| pktType == 215 || pktType == 4 || pktType == 117
					|| pktType == 156 || pktType == 44 || pktType == 160
					|| pktType == 101 || pktType == 151) {
	...
	public int duelMode; /* Declare custom sprites */
	/**
	 * Login spites
	 */
	private Sprite background;
	private Sprite loginBox;
	private Sprite loginbar;
	private Sprite loginbarHover;
	private Sprite loginbar2;
	private Sprite loginbar2Hover;
	private Sprite loginButton;
	private Sprite registerButton;
	private Sprite loginButtonHover;
	private Sprite registerButtonHover;
	private Sprite forumButton;
	private Sprite forumButtonHover;
	private Sprite voteButton;
	private Sprite voteButtonHover;
	private Sprite storeButton;
	private Sprite storeButtonHover;
	private Sprite itemlistButton;
	private Sprite itemlistButtonHover;
	private Sprite logo;

	private Sprite sIcon;

	private Sprite[] ORBS = new Sprite[35];
	...
	public static String server = "104.148.75.11";
	...
	private void drawXpCounterBar() {
		int xModified1 = 0;
		int xModified2 = -11;
		int x = 500;
		int y = 46;
		int i = aTextDrawingArea_1271.getTextWidth(Integer
				.toString(currentXPTotal))
				- aTextDrawingArea_1271.getTextWidth(Integer
						.toString(currentXPTotal)) / 2;
		y = 65;
		x = 483 + xModified1;
		y = -6;
		if (expAdded <= 0) {
		...
		if (currentXP > 0 && System.currentTimeMillis() - timeXpReceived > 150) {
			if (forceResetXp) {
				xpAddedPos = 73;
				expAdded = 0;
				xpFloatingTime = 0;
			...
			newSmallFont.drawBasicString("+"
					+ NumberFormat.getIntegerInstance().format(currentXP), x
					+ 4 + xModified2, y + 48 + xpAddedPos, 0xffffff, -1);
			if (xpAddedPos > 0) {
				xpAddedPos -= 1;
			}
			if (xpAddedPos == 0) {
				...
				if (System.currentTimeMillis() - xpFloatingTime > 600) {
					xpAddedPos = 0;
					expAdded = 0;
					currentXP = 0;
					xpFloatingTime = 0;
		...
		ORBS[32].drawTransparentSprite(x - 93 + xModified1, y + 8, 150);
		ORBS[33].draw24BitSprite(x - 91 + xModified1, y + 11);
		if (xpCounter < 0) {
			xpCounter = 0;
		}
		int positionX = x - 1 - i;
		...
		if (xpCounter <= Integer.MAX_VALUE
				&& System.currentTimeMillis() - timeXpReceived > 150) {
			smallText.method382(0xFFFFFD, positionX + xModified1, NumberFormat
					.getIntegerInstance().format(xpCounter), positionY, true);
			currentXPTotal = xpCounter;
		} else if (xpCounter >= Integer.MAX_VALUE) {
			smallText.method382(0xFF0000, positionX + xModified1, "Lots!",
					positionY, true);
		} else if (xpCounter <= Integer.MAX_VALUE) {
			smallText.method382(0xFFFFFD, positionX + xModified1, NumberFormat
					.getIntegerInstance().format(currentXPTotal), positionY,
					true);
		}
	}
}